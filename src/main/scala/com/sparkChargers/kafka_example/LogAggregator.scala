...
object LogAggregator extends App {
  ...
  val db = connection("adddb")
  val collection = db[BSONCollection]("PerPubGeo")
  ...
  val messages = KafkaUtils.createStream[String, Log, StringDecoder, LogDecoder](streamingContext, kafkaParams, topics, StorageLevel.MEMORY_AND_DISK)
